...
try{if(native('(prefers-color-scheme: dark)').matches)window.__dshThemeBridge.setDark(true)}catch(e){}
})()</script>`;
...
const POLYFILL_SCRIPT =
  '<script>' + POLYFILLS.join('') + '</scr' + 'ipt>' + THEME_BRIDGE_SCRIPT + PICKER_SCRIPT;
